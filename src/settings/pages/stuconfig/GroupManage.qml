...
FluentPage {
 ...
 ColumnLayout{anchors.fill:parent
  ...
  ListView{Layout.fillWidth:true;Layout.fillHeight:true;model:groups;delegate:Frame{width:ListView.view.width;ColumnLayout{width:parent.width
   ...
   Flow{Layout.fillWidth:true;Repeater{model:students;delegate:CheckBox{text:modelData.name;checked:g.member_ids.indexOf(modelData.id)>=0;onToggled:toggle(g,modelData.id,checked)}}}
  }}}
 }
}
